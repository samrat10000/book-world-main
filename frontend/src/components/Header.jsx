...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 py-2 bg-slate-100 z-30 flex h-14 items-center gap-2 border-b border-slate-200 px-4 sm:h-auto sm:border-b sm:px-6 sm:bg-white dark:bg-zinc-950 dark:border-zinc-800">
      ...
      {/* <h1 className="text-2xl md:text-3xl font-mono tracking-tight transition-colors hidden sm:flex dark:text-zinc-50">
        
        Ｂｏｏｋ Ｏｗｌ＇ｓ（インミ） 
      </h1> */}
      
      <h1 className="text-2xl md:text-3xl font-mono tracking-tight select-none">
    <span className="bg-gradient-to-r from-pink-300 via-purple-400 to-indigo-400 bg-clip-text text-transparent">
      Ｂｏｏｋ Ｏｗｌ＇ｓ
    </span>
    <span className="ml-4 text-xl md:text-2xl opacity-80 tracking-wider text-gray-600 dark:text-gray-300">
      「インミ」
    </span>
  </h1>
